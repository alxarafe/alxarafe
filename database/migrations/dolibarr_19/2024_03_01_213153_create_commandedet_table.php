...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('commandedet', function (Blueprint $table) {
            ...
            $table->integer('fk_unit')->nullable()->index('fk_commandedet_fk_unit');
            $table->string('import_key', 14)->nullable();
            $table->string('ref_ext')->nullable();
            $table->integer('fk_commandefourndet')->nullable()->index('fk_commandedet_fk_commandefourndet');
    ...
    {
        Schema::dropIfExists('commandedet');
    }
};
