...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('supplier_proposaldet', function (Blueprint $table) {
            $table->integer('rowid', true);
            $table->integer('fk_supplier_proposal')->index('idx_supplier_proposaldet_fk_supplier_proposal');
            $table->integer('fk_parent_line')->nullable();
            $table->integer('fk_product')->nullable()->index('idx_supplier_proposaldet_fk_product');
            ...
            $table->integer('fk_unit')->nullable()->index('fk_supplier_proposaldet_fk_unit');
        });
    }
    ...
    {
        Schema::dropIfExists('supplier_proposaldet');
    }
};
