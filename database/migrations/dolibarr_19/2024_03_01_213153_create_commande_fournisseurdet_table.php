...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('commande_fournisseurdet', function (Blueprint $table) {
            $table->integer('rowid', true);
            $table->integer('fk_commande')->index('idx_commande_fournisseurdet_fk_commande');
            $table->integer('fk_parent_line')->nullable();
            $table->integer('fk_product')->nullable()->index('idx_commande_fournisseurdet_fk_product');
            ...
            $table->integer('fk_unit')->nullable()->index('fk_commande_fournisseurdet_fk_unit');
    ...
    {
        Schema::dropIfExists('commande_fournisseurdet');
    }
};
