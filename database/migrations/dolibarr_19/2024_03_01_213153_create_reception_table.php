...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('reception', function (Blueprint $table) {
            ...
            $table->integer('fk_soc')->index('idx_reception_fk_soc');
            $table->integer('fk_projet')->nullable();
            $table->string('ref_ext', 30)->nullable();
            $table->string('ref_supplier')->nullable();
            $table->dateTime('date_creation')->nullable();
            $table->integer('fk_user_author')->nullable()->index('idx_reception_fk_user_author');
            $table->integer('fk_user_modif')->nullable();
            $table->dateTime('date_valid')->nullable();
            $table->integer('fk_user_valid')->nullable()->index('idx_reception_fk_user_valid');
            $table->dateTime('date_delivery')->nullable();
            $table->dateTime('date_reception')->nullable();
            $table->integer('fk_shipping_method')->nullable()->index('idx_reception_fk_shipping_method');
            ...
            $table->unique(['ref', 'entity'], 'idx_reception_uk_ref');
        });
    }
