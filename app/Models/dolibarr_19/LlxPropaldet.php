 ...
 *
 * @property LlxPropal $llx_propal
 * @property LlxCUnit|null $llx_c_unit
 *
 * @package App\Models
 */
class LlxPropaldet extends Model
{
	...
	public function llx_propal()
	{
		return $this->belongsTo(LlxPropal::class, 'fk_propal');
	}
