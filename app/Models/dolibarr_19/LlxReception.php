 ...
 * @property Collection|LlxCommandeFournisseurDispatch[] $llx_commande_fournisseur_dispatches
 *
 * @package App\Models
 */
class LlxReception extends Model
{
	...
	public function llx_commande_fournisseur_dispatches()
	{
		return $this->hasMany(LlxCommandeFournisseurDispatch::class, 'fk_reception');
	}
}
