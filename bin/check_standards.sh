...
docker exec alxarafe_php ./vendor/bin/phpcs --standard=phpcs.xml src/Domain src/Application src/Infrastructure src/Modules
...
# docker exec alxarafe_php ./vendor/bin/phpmd src/Domain,src/Application,src/Infrastructure,src/Modules text cleancode,codesize,controversial,design,naming,unusedcode
