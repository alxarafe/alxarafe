@php
    ...
    $currentTheme = $_COOKIE['alx_theme'] ?? \Alxarafe\Infrastructure\Persistence\Config::getConfig()->main->theme ?? 'default';
@endphp

<a class="nav-link dropdown-toggle d-flex align-items-center justify-content-center px-1" 
   style="height: 40px; min-width: 40px;" 
   href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" title="{{ \Alxarafe\Infrastructure\Lib\Trans::_('select_theme') }}">
