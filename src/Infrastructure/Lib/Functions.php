...
use Alxarafe\Infrastructure\Testing\HttpResponseException;
...
abstract class Functions
{
    ...
    public static function exec(string $command): void
    {
        ...
        \Alxarafe\Infrastructure\Tools\Debug::message("Command executed: $command. Output: " . implode("\n", $output));
    }
    ...
    public static function recursiveRemove(string $dir, bool $removeRoot = false): int
    {
        ...
        $objects = scandir($dir);
        if ($objects === false) {
            \Alxarafe\Infrastructure\Tools\Debug::message("Failed to scandir: $dir");
            return 0;
        }
            ...
            if ($object !== "." && $object !== "..") {
                ...
                if (is_dir($path) && !is_link($path)) {
                    ...
                    if (unlink($path)) {
                        ...
                        \Alxarafe\Infrastructure\Tools\Debug::message("Failed to unlink: $path");
                    }
                }
            }
        }
        ...
        if ($removeRoot) {
            if (rmdir($dir)) {
                ...
                \Alxarafe\Infrastructure\Tools\Debug::message("Failed to rmdir: $dir");
            }
        }
