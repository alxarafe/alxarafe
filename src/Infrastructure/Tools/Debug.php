...
use Alxarafe\Infrastructure\Tools\DebugBarCollector\PhpCollector;
use Alxarafe\Infrastructure\Tools\DebugBarCollector\TranslatorCollector;
...
abstract class Debug
{
    ...
    private static function getCaller(): array
    {
        ...
        // Priority: ALX_PATH (common root), then APP_PATH, then BASE_PATH
        $rootPath = defined('ALX_PATH') ? constant('ALX_PATH') : (defined('APP_PATH') ? constant('APP_PATH') : constant('BASE_PATH'));
        $caller['file'] = str_replace($rootPath . '/', '', $caller['file']);
        return $caller;
    }
