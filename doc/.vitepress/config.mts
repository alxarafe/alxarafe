            ...
            '/en/': [
                {
                    ...
                    items: [
                        ...
                        { text: 'Theme Architecture', link: '/en/frontend/theme_architecture' },
                        { text: 'Theme System', link: '/en/frontend/theme_system' },
                        { text: 'Template Engine', link: '/en/template_engine' },
                        { text: 'Template Schema', link: '/en/template_schema' },
                        { text: 'Extensible Tabs', link: '/en/extensible_tabs' },
            ...
            '/es/': [
                {
                    ...
                    items: [
                        ...
                        { text: 'Arquitectura de Temas', link: '/es/frontend/arquitectura_temas' },
                        { text: 'Sistema de Temas', link: '/es/frontend/sistema_de_temas' },
                        { text: 'Motor de Plantillas', link: '/es/motor-plantillas' },
                        { text: 'Esquema de Plantillas', link: '/es/esquema_de_plantillas' },
                        { text: 'Pestañas Extensibles', link: '/es/pestanas_extensibles' },
