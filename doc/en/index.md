...
The easiest way to start is by using the project template:
...
To add Alxarafe to an existing project as a library:
...
*   [Themes](themes.md)
*   [Theme Architecture & Assets](frontend/theme_architecture.md)
*   [Theme System and Overriding](frontend/theme_system.md)
*   [Template Schema](template_schema.md)
*   [Extensible Tabs](extensible_tabs.md)
